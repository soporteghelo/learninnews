...
export const AUDIENCE_CONFIG = {
  profiles: [
    ...
    {
      id: 'Empleado Superficie',
      label: 'Empleado Superficie',
      icon: 'Briefcase',
      description: 'Personal administrativo y técnico (Oficina)',
      color: 'blue',
    },
    {
      id: 'Empleado Mina',
      label: 'Empleado Mina',
      icon: 'Pickaxe',
      description: 'Personal operativo en que ingresa a interior mina',
      color: 'purple',
    },
    {
      id: 'Energías',
  ...
  topics: [
    {
      ...
      audience: 'Empleado Superficie, Empleado Mina',
    ...
    },
    {
      ...
      audience: 'Conductor, Empleado Superficie',
