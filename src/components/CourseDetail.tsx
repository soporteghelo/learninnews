          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <section data-tour="detalle-resumen">
              <div className="flex items-center gap-2 mb-2 text-blue-400">
                ...
                <h2 className="text-xs font-bold uppercase tracking-widest">Resumen del Módulo</h2>
              </div>
              <div className="glass-card rounded-xl p-4 text-slate-300 text-sm leading-relaxed">
            ...
            {topic.keyPoints && topic.keyPoints.length > 0 && (
              <section>
                <div className="flex items-center gap-2 mb-2 text-amber-400">
                  ...
                  <h2 className="text-xs font-bold uppercase tracking-widest">Puntos Clave</h2>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {topic.keyPoints.map((point, i) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 glass px-3 py-2.5 rounded-xl border-l-4 border-amber-500/50"
                    >
                      <div className="w-2 h-2 shrink-0 rounded-full bg-amber-500" />
                      <span className="text-slate-200 text-xs font-semibold leading-snug">{point}</span>
                    </motion.div>
                  ))}
                </div>
              </section>
              ...
              {hasQuiz && (
                <div data-tour="detalle-nota" className="pt-4 mt-2 border-t border-slate-700/50">
                  ...
                  <p className="text-[10px] text-slate-500 text-center mt-1.5">
                    Nota mínima aprobatoria: <span className="text-slate-400 font-bold">16 / 20</span>
                  </p>
                </div>
              )}
            </div>
